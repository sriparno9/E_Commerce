...
public class TestCase5 {
	...
	public void setUp() throws Exception {
	  ...
	  public void testTestCase5() throws Exception {
	    ...
	    driver.findElement(By.id("email_address")).sendKeys("qwertyuiop@gmail.com");
	    ...
	    driver.findElement(By.id("message")).sendKeys("Hey!! this LCD TV looks ok, check it out !!.. cheers .. Berry");
